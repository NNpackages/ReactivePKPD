...
$.extend(timeInputBinding, {
  ...
  find: function(scope) {
    return $(scope).find('input[type="time"]');
  },
  ...
  subscribe: function(el, callback) {
    $(el).on('keyup.timeInputBinding input.timeInputBinding', function(event) {
      callback(true);
...
Shiny.inputBindings.register(timeInputBinding, 'shiny.timeInput');